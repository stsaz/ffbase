...
ffring_write_finish
ffring_read_begin ffring_read_min_begin ffring_read_all_begin ffring_read_max_begin
...
static inline ffring_head _ffring_write_x_begin(ffring *b, ffsize n, ffstr *d1, ffstr *d2, ffsize *free, ffuint how)
{
	ffring_head wh;
	ffsize i, _free;
...
{
	ffstr d2;
	return _ffring_write_x_begin(b, n, dst, &d2, free, _FFRING_F_MAX1);
}
...
{
	return _ffring_write_x_begin(b, n, d1, d2, free, _FFRING_F_EXACT);
}
...
static inline ffring_head _ffring_read_x_begin(ffring *b, ffsize n, ffstr *d1, ffstr *d2, ffsize *used, ffuint how)
{
	ffring_head rh;
	ffsize i, _used;
...
{
	ffstr d2;
	return _ffring_read_x_begin(b, n, dst, &d2, used, _FFRING_F_MAX1);
}

/** Lock data region of minimum 'n' bytes.
used: (output) amount of used space after the operation
Return value for ffring_read_finish() */
static inline ffring_head ffring_read_min_begin(ffring *b, ffsize n, ffstr *d1, ffstr *d2, ffsize *used)
{
	return _ffring_read_x_begin(b, n, d1, d2, used, _FFRING_F_MIN);
}
...
{
	return _ffring_read_x_begin(b, n, d1, d2, used, _FFRING_F_EXACT);
}

/** Lock data region with the maximum size of 'n' bytes.
used: (output) amount of used space after the operation
Return value for ffring_read_finish() */
static inline ffring_head ffring_read_max_begin(ffring *b, ffsize n, ffstr *d1, ffstr *d2, ffsize *used)
{
	return _ffring_read_x_begin(b, n, d1, d2, used, _FFRING_F_MAX);
}
